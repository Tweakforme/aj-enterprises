...
export default function Work() {
  ...
  return (
    <section id="work" className="relative py-16 sm:py-20 lg:py-24 xl:py-28 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 border border-primary/20 bg-primary/5 rounded-full mb-6">
            <span className="text-xs font-bold text-primary uppercase tracking-wide">Our Work</span>
          </div>
          ...
          <p className="text-base sm:text-lg text-white/60 leading-relaxed">
            Real websites for real businesses. From e-commerce platforms to custom web applications,
            see how we turn ideas into high-performance digital solutions.
          </p>
        </motion.div>
